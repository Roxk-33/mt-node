...
module.exports = app => {
  ...
  router.get(
    '/client/user/address',
    verfiyToken,
    controller.user.getAddressList
  ); //-获取用户收货地址
  router.get(
    '/client/user/address/:id',
    verfiyToken,
    controller.user.getAddressDetail
  ); //-获取用户收货地址详情
  router.get(
    '/client/user/phone/vercode',
    verfiyToken,
    controller.user.getVercode
  ); //-获取手机修改验证码
  ...
  router.get(
    ...
    verfiyToken,
    controller.user.getEvalList
  );
  router.delete(
    '/client/user/evaluation/:id',
    verfiyToken,
  ...
  // 具体展示那些商品由前端处理
  router.get(
    '/client/user/cart/settle/:shopId',
    verfiyToken,
  ...
  router.put(
    '/client/user/order/:id/confirm',
    verfiyToken,
    controller.order.confirmOrder
  );
  router.put(
    '/client/user/order/:id/refund',
    verfiyToken,
    controller.order.applyRefund
  ); // 申请退款
  // 用户-取消订单
  router.put('/client/user/order/:id', verfiyToken, controller.order.cancel);
  // 评价
  router.post(
    '/client/user/order/:id/review',
    verfiyToken,
